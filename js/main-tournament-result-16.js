// =========================================================
// MAIN TOURNAMENT RESULT - 16 PARTICIPANTS
// =========================================================
...
function getParticipantBySlot16(
    location,
    round
) {
    ...
    if (
        ...
        return findParticipantFromCurrent16(
            location
        );
    ...
    if (
        ...
        return findParticipantFromMemory16(
            location,
            round
        );
...
function findParticipantFromCurrent16(
    location
) {
...
function findParticipantFromMemory16(
    location,
    round
) {
...
function displayParticipantInSlot16(
    slot
) {
...
// =========================================================
// Display Main Tournament Result 16
// =========================================================

function displayMainTournamentResult16() {

    // =====================================================
    // Get All 16 Tournament Slots
    // =====================================================

    const slots =
        document.querySelectorAll(
            ".player-slot-16[data-location]"
        );
